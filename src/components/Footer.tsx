      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-primary-300 hover:text-accent-400 transition-colors transform hover:scale-110">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li><Link href="/" className="text-primary-200 hover:text-accent-400 transition-colors">Home</Link></li>
              <li><Link href="/products" className="text-primary-200 hover:text-accent-400 transition-colors">Products</Link></li>
              <li><Link href="/categories" className="text-primary-200 hover:text-accent-400 transition-colors">Categories</Link></li>
              <li><Link href="/about" className="text-primary-200 hover:text-accent-400 transition-colors">About Us</Link></li>
              <li><Link href="/contact" className="text-primary-200 hover:text-accent-400 transition-colors">Contact</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li><Link href="/help" className="text-primary-200 hover:text-accent-400 transition-colors">Help Center</Link></li>
              <li><Link href="/shipping" className="text-primary-200 hover:text-accent-400 transition-colors">Shipping Info</Link></li>
              <li><Link href="/returns" className="text-primary-200 hover:text-accent-400 transition-colors">Returns</Link></li>
              <li><Link href="/privacy" className="text-primary-200 hover:text-accent-400 transition-colors">Privacy Policy</Link></li>
              <li><Link href="/terms" className="text-primary-200 hover:text-accent-400 transition-colors">Terms of Service</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-primary-800 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-8 mt-6 md:mt-0">
            ...
            <Link href="/cookies" className="text-primary-300 hover:text-accent-400 transition-colors">
              Cookie Policy
            </Link>
          </div>
        </div>
