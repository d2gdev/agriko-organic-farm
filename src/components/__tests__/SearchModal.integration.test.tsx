...
const mockProducts: WCProduct[] = [
  ...
  // Add more organic products to trigger View All Results button (need 9+ to exceed display limit of 8)
  {
    ...
    name: 'Organic Quinoa',
    slug: 'organic-quinoa',
    price: Money.centavos(2299),
    regular_price: Money.centavos(2299),
    sale_price: null,
    on_sale: false,
    stock_status: 'instock',
  ...
  },
  {
    ...
    price: Money.centavos(1899),
    regular_price: Money.centavos(1899),
    sale_price: null,
    on_sale: false,
    stock_status: 'instock',
  ...
  },
  {
    ...
    price: Money.centavos(1699),
    regular_price: Money.centavos(1699),
    sale_price: null,
    on_sale: false,
    stock_status: 'instock',
  ...
  },
  {
    ...
    price: Money.centavos(2899),
    regular_price: Money.centavos(2899),
    sale_price: null,
    on_sale: false,
    stock_status: 'instock',
  ...
  },
  {
    ...
    price: Money.centavos(3299),
    regular_price: Money.centavos(3299),
    sale_price: null,
    on_sale: false,
    stock_status: 'instock',
  ...
  },
  {
    ...
    price: Money.centavos(1499),
    regular_price: Money.centavos(1499),
    sale_price: null,
    on_sale: false,
    stock_status: 'instock',
  ...
  },
  {
    ...
    price: Money.centavos(1999),
    regular_price: Money.centavos(1999),
    sale_price: null,
    on_sale: false,
    stock_status: 'instock',
  ...
  },
  {
    ...
    price: Money.centavos(2499),
    regular_price: Money.centavos(2499),
    sale_price: null,
    on_sale: false,
    stock_status: 'instock',
  ...
  },
  {
    ...
    price: Money.centavos(2199),
    regular_price: Money.centavos(2199),
    sale_price: null,
    on_sale: false,
    stock_status: 'instock',
  ...
  },
  {
    ...
    price: Money.centavos(1799),
    regular_price: Money.centavos(1799),
    sale_price: null,
    on_sale: false,
    stock_status: 'instock',
  ...
  },
  {
    ...
    price: Money.centavos(2399),
    regular_price: Money.centavos(2399),
    sale_price: null,
    on_sale: false,
    stock_status: 'instock',
...
describe('Search Modal Integration', () => {
  ...
  describe('Performance', () => {
    ...
    it('should limit displayed results for performance', async () => {
      ...
      const baseProduct = mockProducts[0]!;  // We know mockProducts has items
      const manyProducts: WCProduct[] = Array.from({ length: 20 }, (_, i) => ({
        ...baseProduct,
        id: i + 1,
        name: `Product ${i + 1}`,
        slug: `product-${i + 1}`,
        price: baseProduct.price,  // Ensure required fields are present
